...
| `--reporter-cli-terminal-width` | This allows overriding the default wrapping width for output generated by console.* statements in the collections's scripts. This does not apply to regular CLI reporter output. |
