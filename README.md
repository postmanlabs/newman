# Newman [![Build Status](https://travis-ci.org/abhijitkane/Newman.svg?branch=master)](https://travis-ci.org/abhijitkane/Newman) [![Built with Grunt](https://cdn.gruntjs.com/builtwith.png)](http://gruntjs.com/)
