...
| options.globals           | Postman Global Variables can be optionally passed on to a collection run in form of path to a file or URL. It also accepts variables as an `object`. <br />e.g `globals: { "id": "00000000-0000-0000-0000-000000000000", "name": "Postman Globals", "values": [{ "key": "user", "value": "someUser", "enabled": true, "type": "text" }], "_postman_variable_scope": "globals" }` <br /><br />_Optional_<br />Type: `object\|string` |
