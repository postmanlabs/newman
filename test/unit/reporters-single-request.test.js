describe('Reporter Options', function () {
    ...
    it('should correctly work with json reporter options', function (done) {
        // eslint-disable-next-line max-len, quotes
        exec('node ./bin/newman.js request -X GET "https://5a178277-8664-409c-8e93-d5ee2935d2cb.mock.pstmn.io/get-json" -r json"', function (code) {
            expect(code, 'should have exit code of 0').to.equal(0);
            done();
        });
    });
