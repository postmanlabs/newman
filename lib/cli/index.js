...
var _ = require('lodash'),
    ...
    execute = (program) => {
        ...
        // @todo This is conflicting with '-r: --reporters'. Should we remove this?
        // Also for this we have '--timeout-request'
    ...
    _request = () => {
        ...
        requestOptionsParser.addArgument(['--timeout-global'], {
            help: 'Specify a timeout for collection run (in milliseconds)',
            type: Integer,
            defaultValue: 0
        });
        ...
        requestOptionsParser.addArgument(['--timeout-script'], {
            help: 'Specify a timeout for script (in milliseconds)',
            type: Integer,
            defaultValue: 0
        });
