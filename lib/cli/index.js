        ...
        */
        ...
        program
            ...
            .action(function (collection, options) {
                ...
                program.timeoutRequest = options.timeoutRequest;
                program.timeoutScript = options.timeoutScript;
                program.ignoreRedirects = options.ignoreRedirects;
                program.insecure = options.insecure;
                program.sslClientCert = options.sslClientCert;
                program.sslClientKey = options.sslClientKey;
                program.sslClientPassphrase = options.sslClientPassphrase;
            })
            .parse(process.argv);
