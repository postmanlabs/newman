const crypto = require('crypto'),
    ...
    // illegal unicode code point values which is encoded in two bytes
    illegals = [
        0, // null
        10, // newline
        13, // carriage return
...
module.exports = {
    ...
    encrypt: (data, key) => {
        ...
        data = cipher.update(data,
            ENCRYPTION_INPUT_ENCODING, ENCRYPTION_OUTPUT_ENCODING);
    ...
    decrypt: (data, key) => {
        ...
        data = decipher.update(data,
            ENCRYPTION_OUTPUT_ENCODING, ENCRYPTION_INPUT_ENCODING);
