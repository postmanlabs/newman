...
module.exports = function (options, callback) {
    ...
    config.get(options, { loaders: configLoaders, command: 'run' }, function (err, options) {
        ...
        options.collection = new Collection(Collection.isCollection(options.collection) ?
            ...
            // to a collection
            options.collection.toJSON() : options.collection);
        ...
        runner.run(options.collection, {
            ...
            _.isArray(reporters) && _.each(reporters, function (reporterName) {
                ...
                (emitter.reporters || (emitter.reporters = {}))[reporterName] =
                    new (require('./reporters/' + reporterName))(emitter,
