var _ = require('lodash'),
    ...
    configLoaders = {
        ...
        iterationData: externalLoader.bind(this, 'iterationData') // todo: use a csv parser to allow csv files.
    };
...
module.exports = function (options, callback) {
    ...
    config.get(options, { loaders: configLoaders, command: 'run' }, function (err, options) {
        ...
        options.collection && runner.run(options.collection, {
            ...
            iterationData: options.iterationData, // todo: should this have a better name?
