var _ = require('lodash'),
    ...
    extractModel = function (source, type) {
        if (!_.isObject(source && (source = source[type] || source))) { return undefined; } // extract object that holds variable
...
module.exports = function (options, callback) {
    ...
    config.get(options, { loaders: configLoaders, command: 'run' }, function (err, options) {
        ...
        // _.assign(options, {
        //     environment: extractModel(options, 'environment'),
        //     globals: extractModel(options, 'globals'),
        //     collection: extractModel(options, 'collection')
        // });
