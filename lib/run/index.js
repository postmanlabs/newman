...
module.exports = function (options, callback) {
    ...
    getOptions(options, function (err, options) {
        ...
        var secureFileResolver = new SecureFS(options.workingDir, options.insecureFileRead),
            sslClientCertList = [];
        ...
        if (options.sslClientCertList) {
            ...
            if (!Array.isArray(sslClientCertList)) {
                return callback(new Error('newman: expected type for ssl client certificates list to be array.'));
            }
        }
