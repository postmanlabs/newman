...
module.exports = function (options, callback) {
    ...
    getOptions(options, function (err, options) {
        ...
        runner.run(options.collection, {
            ...
            // todo: add support for more types of timeouts, currently only request, script is supported
            timeout: { request: options.timeoutRequest, script: options.timeoutScript } || undefined,
            fileResolver: fs,
            requester: {
