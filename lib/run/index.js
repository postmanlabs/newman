...
module.exports = function (options, callback) {
    ...
    getOptions(options, function (err, options) {
        ...
        runner.run(options.collection, {
            ...
            suppressExitCode: options.suppressExitCode,
            ...
            _.extend(callbacks, {
                ...
                // override the `done` event to fire the end callback
                    ...
                    _.each(['environment', 'globals', 'collection'], function (item) {
                        ...
                        _.isString(path) && emitter.summary.exports.push({
                            type: item,
                            path: path,
                    ...
                    asyncEach(emitter.summary.exports, exportFile, function (err) {
            ...
            _.isArray(reporters) && _.each(reporters, function (reporterName) {
                ...
                if (!Reporter) {
                    ...
                    catch (error) { throw error; } // eslint-disable-line no-empty
                }
