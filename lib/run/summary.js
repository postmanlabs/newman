...
RunSummary = function RunSummary (emitter, options) {
    ...
    var summary = this,
        // skipRequestReport in case the option is specified or only cli
        // is specified as reporter
        skipRequestReport = _.get(options, 'skipRequestReport') ||
            (_.isArray(summary.reporters) &&
            summary.reporters.length === 1 &&
            summary.reporters.includes('cli'));
