    ...
    _.assign(summary, /** @lends RunSummary.prototype */ {
        ...
        run: {
            ...
            timingPhases: {
                ...
                /**
                 * The duration of tcp connection
                 *
                 * @type {number}
                 */
                tcp: 0,
                ...
                /**
                 * The duration of secure handshake
                 *
                 * @type {number}
                 */
                secureHandshake: 0,
                ...
                /**
                 * The duration of HTTP server response
                 *
                 * @type {number}
                 */
                firstByte: 0,
                ...
                /**
                 * The duration of entire HTTP roundup
                 *
                 * @type {number}
                 */
                total: 0
            ...
            /**
             * Stores information on the verbose session
             *
             * @type {Object}
             */
            verboseSession: {
...
_.assign(RunSummary, {
    ...
    attachRequestTracker (summary, emitter) {
        ...
        emitter.on('request', function (err, o) {
            ...
            summary.run.timingPhases = timingPhases;
            summary.run.verboseSession = _.findLast(_.get(o, 'history.execution.sessions'));
