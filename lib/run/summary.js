 ...
 *
 * @returns {Object} - A wrapper around object and toJSON helper methods, to convert the given summary object to JSON
 */
proxyPropertyList = function (options, name) {
    return {
         ...
         *
         * @type {Function}
         * @returns {Object<String>} - The object representation of the provided property name.
         */
        object: function () {
