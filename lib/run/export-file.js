...
module.exports = function (options, done) {
    ...
    var path = _.isString(options.path) && parsePath(options.path),
        content = _.isArray(options.content) || _.isPlainObject(options.content) ? // global run variable array exports
            JSON.stringify(options.content, 0, 2) : // @todo: Fix all associated pieces of logic
            (options.content || E);
