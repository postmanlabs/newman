const fs = require('fs'),
    ...
    DEPRECATED_F_OK = 'F_OK',
    DEPRECATED_R_OK = 'R_OK',
    DEPRECATED_W_OK = 'W_OK',
    DEPRECATED_X_OK = 'X_OK',
...
Object.getOwnPropertyNames(fs).map((prop) => {
    ...
    if ([
        ...
        DEPRECATED_W_OK,
        DEPRECATED_X_OK,
        DEPRECATED_SYNC_WRITE_STREAM,
        EXPERIMENTAL_PROMISE,
    ].includes(prop) || typeof fs[prop] !== FUNCTION) {
        return;
    }
