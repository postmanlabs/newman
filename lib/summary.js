...
_.assign(RunSummary, {
    attachReportingTrackers: function (summary, emitter) {
        ...
        var getExecution = function (obj, cursor, defaults) {
            ...
            !obj.executions && (obj.executions = []);

            return _.merge(obj.executions[cursor.iteration] || (obj.executions[cursor.iteration] = {}), defaults);
        };
    ...
    attachFailureTrackers: function (summary, emitter) {
        ...
        // NOTE that surrogate events (which throw duplucate arguments) are not recorded
