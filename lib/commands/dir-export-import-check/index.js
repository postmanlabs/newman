...
function cliSetup (program) {
    return program
        .command('dir-export-import-check <postman-collection-file>')
        ...
        .option('-p, --pretty-print-body',
            'pretty-print JSON request body with 4-space indent');
}
...
function action (collectionFile, command) {
    ...
    outputCollection = dirUtils.dirTreeToCollectionJson(collectionDir, options);
