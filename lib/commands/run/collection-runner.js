...
module.exports = {
    optionCollector (program, collection, command) {
        let options = commandUtil.commanderToObject(command),

            // parse custom reporter options
            reporterOptions = commandUtil.parseNestedOptions(program._originalArgs, '--reporter-', options.reporters);
