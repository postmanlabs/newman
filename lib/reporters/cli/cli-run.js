 ...
 * @returns {*}
 */
PostmanCLIRunReporter = function (emitter, reporterOptions, options) {
    ...
    emitter.on('done', function () {
        ...
        if (!reporterOptions.noSummary) {
            print(LF + PostmanCLIRunReporter.parseStatistics(run.stats, run.timings, run.transfers, options) + LF);
        }
...
_.assignIn(PostmanCLIRunReporter, {
...
PostmanCLIRunReporter.prototype.dominant = true;

module.exports = PostmanCLIRunReporter;
