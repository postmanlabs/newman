...
cliUtils = {
     ...
     *
     * @param {?Object} options - A flag to indicate usage of the --color option.
     * @param {?Boolean} options.color - A flag to indicate usage of the --color option.
     * @param {?Boolean} options.noColor - A flag to indicate usage of the --no-color option.
     * @returns {Boolean} - A boolean value depicting the result of the noTTY check.
     */
    noTTY: function (options) {
        return _.get(options, 'noColor') || _.get(options, 'color') === false ||
    ...
    inspector: function (runOptions) {
        var dimension = cliUtils.dimension(),
            options = {
                ...
                colors: !cliUtils.noTTY(runOptions),
