...
cliUtils = {
    ...
    /**
     * A helper function which returns a string with the timestamp of current time
     * (i.e The time when this function is called)
     *
     * @returns {String} - A string carrying timestamp
     */
