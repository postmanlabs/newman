...
_.assignIn(PostmanCLIReporter, {
     ...
     * @param {String} timings.totalMin - The minimum response time of the run
     * @param {String} timings.totalMax - The maximum response time of the run
     * @param {String} timings.totalSd - Standard deviation of response time of the run
