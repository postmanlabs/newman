...
PostmanCLIReporter = function (emitter, reporterOptions, options) {
    ...
    emitter.on('done', function () {
        ...
        if (options.singleRequest &&
            ...
            run.transfers.responseTotal < 10485760) {
            print('\n');
            ...
            if (run.executions[0].response.contentInfo().mimeFormat === 'xml') {
        ...
        if (run.transfers.responseTotal > 10485760) {
            print('\n');
        ...
        if (options.verbose && options.singleRequest) {
            print('\n');
            print('addresses: ');
            print(PostmanCLIReporter.verboseSession(run).addresses);
            print('\n\n');
            print('tls: ');
            print(PostmanCLIReporter.verboseSession(run).tls);
        }
    });
