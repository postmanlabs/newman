...
JunitReporter = function (newman, reporterOptions) {
    newman.on('beforeDone', function () {
        ...
        if (reporterOptions.export) { console.info(`Report saved at ${reporterOptions.export}`); }
        else {
            console.info('No path passed!\nReport is written to newman/ in the current working directory.');
        }
    });
};
