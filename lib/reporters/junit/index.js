 ...
 * @param {Object} options - A set of options for the current collection run.
 * @param {Object} nameCache - A set of item id - full name key-value pairs.
 * @returns {*}
 */
JunitReporter = function (newman, reporterOptions, options, nameCache) {
    newman.on('beforeDone', function () {
        ...
        _.forEach(cache, function (executions, itemId) {
            ...
            suite.att('name', util.getFullName(currentItem, options, nameCache));
